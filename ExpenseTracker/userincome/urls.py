...
urlpatterns = [
    ...
    path('export_csv', views.iexport_csv, name='iexport-csv'),
    path('export_excel', views.iexport_excel, name='iexport-excel'),
    path('export_pdf', views.iexport_pdf, name='iexport-pdf'),
]
